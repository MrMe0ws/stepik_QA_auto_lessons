...
# Класс ТестРегистратион сделан для того, чтоб тест реально стал успешным
    ...
    def test_form_submission(self):
        ...
        try:
            ...
            input4 = browser.find_element(
                By.CSS_SELECTOR, 'input[placeholder="Input your phone:"]')
            input4.send_keys('89274168999')

            input5 = browser.find_element(
                By.CSS_SELECTOR, 'input[placeholder="Input your address:"]')
            input5.send_keys('Kierok')
